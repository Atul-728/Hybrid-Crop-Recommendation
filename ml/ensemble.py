...
def load_base_models():
    ...
    return rf_model, xgb_model, lgbm_model, cat_model
...
def run_ensemble():
    ...
    rf_model, xgb_model, lgbm_model, cat_model = load_base_models()

    base_models = [rf_model, xgb_model, lgbm_model, cat_model]

    # Create meta features
    X_meta_train = create_meta_features(base_models, X_train)
    X_meta_test = create_meta_features(base_models, X_test)
